 ...
 * @property {(params: {owner: string, repo: string, pull_number: number}) => Promise<{data: {head: {ref: string, sha: string, repo?: {full_name: string}}, base: {ref: string, repo?: {full_name: string}}, title?: string, body?: string}}>} rest.pulls.get
 * @property {(params: {owner: string, repo: string, pull_number: number, title?: string, body?: string}) => Promise<{data: {number: number}}>} rest.pulls.update
 ...
 * @property {{trigger_text?: string, actor?: string, agent?: string, model?: string, model_id?: string, effort?: string, recover_thread?: string, runner_mode?: string}} [inputs]
